...
public class TokenProvider implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7373547294782389071L;
	...
	public void setExpirationDateFromToken(String token) {
		Jwts.parser().setSigningKey(Constants.SIGNING_KEY).parseClaimsJws(token).getBody()
...
//		return (redisTemplate.hasKey(username) && username.equals(userDetails.getUsername()) && !isTokenExpired(token));
